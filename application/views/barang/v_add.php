				  ...
				  <div class="col-sm-4">
					...
					<div class="col-sm-4">
                      ...
                      <div class="form-group">
                        ...
                        <input name="berat" type="number" min = "500" class="form-control" placeholder="berat dalam satuan gram"  value="<?=set_value('berat') ?>" required>
                      </div>
                    </div>	 	
				  </div>	
          <div class="row">
				  ...
				  <div class="form-group">
                        ...
                        <textarea name="deskripsi" class="form-control" rows="3" placeholder="Enter ..." value="<?=set_value('deskripsi') ?>"></textarea>
                      </div>
					<div class="form-group">
