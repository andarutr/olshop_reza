		...
		<div class="col-md-5">
			...
			<div class="col-sm-8">
				<div class="form-group">
					<select class="form-select" id="tujuanPengantaran">
			...
			<div class="col-sm-8">
				<div class="form-group">
					<select class="form-select" id="pilihEkspedisi">
            ...
            <a href="<?= base_url('belanja') ?>" rel="noopener" target="_blank" class="btn btn-sm btn-danger"><i class="bi bi-arrow-90deg-left"></i>
				Kembali Ke keranjang</a>
			<button type="submit" class="btn btn-sm btn-success float-right" id="btnSubmitCheckout"><i class="bi bi-credit-card"></i> Proses
				Chekout</button>
		</div>
